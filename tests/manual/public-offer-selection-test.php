...
foreach ([
    ...
    'data-product-id="123"',
    'data-va-product-image',
    'data-va-product-image-missing',
    'Ofertas disponibles',
    'Selecciona el minimarket donde deseas comprar.',
    'role="radiogroup"',
    'data-va-offer-list',
...
foreach ([
    ...
    'selectionLocked', 'setSelectionLocked',
    "selected ? '● Seleccionado' : '○ Seleccionar'",
    'renderProductImage', "parsed.protocol === 'http:'", "parsed.protocol === 'https:'",
    "parsed.username === ''", "parsed.password === ''",
    'reloadSequence', 'sequence !== reloadSequence',
...
foreach ([
    ...
    '.veciahorra-frontend .va-offer-card__choice',
    '.veciahorra-frontend .va-product-detail__image',
    'body:has(.veciahorra-frontend .va-product-detail) .entry-header',
