...
$assert(isset($registered['veciahorra-orders-detail-app']), 'detail route did not load application');
...
$assert(str_contains($pageSource, 'assets/admin/js/modules/orders/detail-app.js'), 'detail application asset is absent');
