...
try{
    ...
    $order=rInsert($p.'orders',['customer_id'=>$customer,'minimarket_id'=>$store,'total'=>'1000.00','status'=>'paid','reservation_expires_at'=>$future,'created_at'=>$now,'updated_at'=>$now],$ids);
