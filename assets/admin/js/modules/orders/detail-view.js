...
export function createOrderDetailView({
    ...
    function summarySection(detail) {
        ...
        section.append(definitions([
            ...
            ['Subtotal productos global', money(detail.checkout?.product_subtotal, detail.totals.currency)],
            ['Cargo por uso de VeciAhorra', money(detail.checkout?.platform_fee, detail.totals.currency)],
            ['Despacho global', money(detail.checkout?.delivery_fee, detail.totals.currency)],
            ['Total global pagado', money(detail.checkout?.total, detail.totals.currency)],
