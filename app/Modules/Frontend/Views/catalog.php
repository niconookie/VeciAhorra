...
<section class="veciahorra-frontend va-design-system va-catalog" data-va-catalog data-product-urls="<?php echo esc_attr(is_string($encodedUrls) ? $encodedUrls : '{}'); ?>" data-catalog-url="<?php echo esc_url($catalogUrl); ?>" aria-labelledby="<?php echo esc_attr($titleId); ?>">
    <header class="va-catalog__hero va-section-heading">
        <p class="va-catalog__eyebrow va-eyebrow"><?php esc_html_e('Compra local, ahorra cerca', 'veciahorra'); ?></p>
    ...
    <form class="va-catalog__filters va-card va-field-group" data-va-catalog-filters>
        <div class="va-field">
        ...
        <div class="va-catalog__filter-actions">
            <button class="va-button va-button--primary" type="submit"><?php esc_html_e('Aplicar filtros', 'veciahorra'); ?></button>
    ...
    <div class="va-catalog__results-header">
        <p role="status" aria-live="polite" aria-atomic="true" data-va-catalog-status><?php esc_html_e('Cargando resultados…', 'veciahorra'); ?></p>
    </div>
