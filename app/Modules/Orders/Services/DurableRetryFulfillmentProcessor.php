...
final class DurableRetryFulfillmentProcessor implements DurableRetryStageProcessorInterface
{
    private const LEASE_SECONDS = 600;

    private const SUCCESS_REASONS = [
        'pickup_fulfillment_completed',
        'delivery_fulfillment_completed',
    ];
    ...
    public function __construct(
        private readonly FulfillmentCompletionAttemptProcessorInterface $attemptProcessor,
        private readonly FulfillmentCompletionReadAuthorityInterface $readAuthority
    ) {
    }

    public function stage(): string
    {
        return DurableRetryStage::FULFILLMENT_COMPLETION;
    }
    ...
    {
        return $context->stage() === DurableRetryStage::FULFILLMENT_COMPLETION
    ...
    private function classify(
        DurableRetryExecutionContext $context,
        ?array $authority,
        ?FulfillmentCompletionResult $attempt,
        ...
        if ($status === 'completed'
            && in_array($reason, self::SUCCESS_REASONS, true)
        ...
        return $infrastructureFailure
            || ($attempt !== null
                && in_array($attempt->status, [
                    ...
                    FulfillmentCompletionResult::ALREADY_COMPLETED,
