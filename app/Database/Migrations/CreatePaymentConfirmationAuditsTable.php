...
use VeciAhorra\Database\Schemas\PaymentConfirmationAuditSchema;

final class CreatePaymentConfirmationAuditsTable
{
    ...
    public function up(): void
    {
        ...
        $schema = new PaymentConfirmationAuditSchema();
        $name = $this->tableName
